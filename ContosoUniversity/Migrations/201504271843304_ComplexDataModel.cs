namespace ContosoUniversity.Migrations
{
    ...
    public partial class ComplexDataModel : DbMigration
    {
        public override void Up()
        {
            ...
            // default value for FK points to department created above. AddColumn("dbo.Course", "DepartmentID", c => c.Int(nullable: false, defaultValue: 1)); //AddColumn("dbo.Course", "DepartmentID", c => c.Int(nullable: false));
